      ...
      <article className='footerPages__container'>
        ...
        <List
          ...
          textAfter={<Paragrafs
            paragrafs={[
              ...
              'WARNING: There may are fake websites pretending to be WhitePhoenix (aka "phishing scams"). They may use a misspelled URL that looks like "https://wphoenix.com" in order to trick users into sending them funds. DO NOT USE ANY SERVICE THAT ISN’T EXACTLY LOCATED AT THE DOMAIN: "https://wphoenix.com" WhitePhoenix is not responsible for funds that have been sent to these fake WhitePhoenix phishing sites. It is important that all users verify they are visiting the correct URL (wphoenix.com) and search for the security certificate in the URL bar of their browser. Also, never trust private messages, solicitations, or requests for funds from people claiming to be WhitePhoenix unless you have verified that it is an official request from a company employee. When in doubt, contact us directly to verify any messaging. Stay diligent – and please report any phishing scams.'
            ]}
          />}
        />
        ...
        <List
          list={[
            ...
            'Our representatives will only contact you from email threads @wphoenix.com. If you notice any abnormal behavior or you are not sure if any request addressed to you is legitimate you should notify us immediately in our Contact Us form, from the Support Center. A representative will attend to your needs as soon as possible and ascertain the authenticity of the relevant request accordingly.',
        ...
        <List
          ...
          list={[
            ...
            'Deposits that are credited in our addresses without being associated with an active order will be treated as unspecified deposits and will be kept in our systems. In addition, if for any order, the transaction can not be completed, the deposited amount remains in our systems. In such cases, and in all possible situations, after which your deposit remains in our systems WhitePhoenix will try to contact you to inform you and issue a refund. If we do not have any contact information you will have to contact us yourself at support@wphoenix.com to request a refund. On the email, you may use as subject "Claim Deposit" and you will have to provide information such as the Blockchain transfer Hash/TXID, wallet addresses involved, sent currency, amount, or any other information that may be required in order to verify the ownership of the funds. Once you contact us and provide the above, a refund will be issued to the originating address.'
        ...
        <Paragrafs
          paragrafs={[
            ...
            'WhitePhoenix and You, agree to notify each other of any dispute in less than thirty (30) days from the time that it arises. You may notify WhitePhoenix of such a dispute by contacting our legal department through email at legal@wphoenix.com.',
        ...
        <Paragrafs
          paragrafs={[
            'If you have any complaints, feedback or questions, kindly contact us at support@wphoenix.com and we will, in our best efforts try to resolve it for you'
          ]}
        />
